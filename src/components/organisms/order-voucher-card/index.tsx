...
import {OrderVoucherCardTypes} from "./orderVoucherCard.types";
...
const OrderVoucherCard: React.FC<OrderVoucherCardTypes> = ({order}) => {
    ...
    return (
        <PressBox onPress={_navigateToDetail} p={3} bgColor="white" borderRadius={10} flexDirection="row">
            <Box borderRadius={6} flex={3}>
                <Image uri={promotion.avatar.url} rounded="lg" width="100%" height={20}/>
            </Box>

            <VStack pl={3}  flex={10}>
                <Typo type="subtitle16">{promotion.title}</Typo>
...
export default OrderVoucherCard
