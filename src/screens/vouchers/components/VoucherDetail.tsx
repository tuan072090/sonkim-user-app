            ...
            <ScrollView >
                ...
                <Box m={4}>
                    <Box bgColor="white" rounded="xl" py={4} px={3} my={3}>
                        <VStack>
                            <Center>
                                <Text textAlign="center" color="#095A64" fontWeight="bold" fontStyle="normal" fontSize="md" lineHeight="md" letterSpacing="lg" textTransform="uppercase">Khuyến mãi giảm 20% cho dịch vụ massage vào tháng 10</Text>
                                <ImageStatic uri={StaticImages.voucher1} borderRadius={4} width={56} height={56} my={4}/>
                            </Center>
                    ...
                    <Box py={1} px={3} mb={20}>
                        <Text color="primary.500" fontWeight="bold" fontStyle="normal" fontSize="sm" lineHeight="xs" letterSpacing="lg">Điều khoản áp dụng:</Text>
                        ...
                        <HStack alignItems="center" justifyContent="space-around" my={4}>
                            <ImageStatic uri={StaticImages.voucher_detail1} rounded="md" width={24} height={24}></ImageStatic>
                            <ImageStatic uri={StaticImages.voucher_detail2} rounded="md" width={24} height={24}></ImageStatic>
                            <ImageStatic uri={StaticImages.voucher_detail3} rounded="md" width={24} height={24}></ImageStatic>
                        </HStack>
                    </Box>
                </Box>
            </ScrollView>
            <HStack bgColor="white" height={20} alignItems="center" justifyContent="space-around" position="absolute" bottom={0} width="100%">
                <Text color="primary.500" fontWeight="semibold" fontStyle="normal" fontSize="xl" lineHeight="lg" >Miễn phí</Text>
                <Button bgColor="primary.500" rounded="xl" size="lg" color="white" width={48}>
                    Đổi voucher
                </Button>
            </HStack>
        </Box>
