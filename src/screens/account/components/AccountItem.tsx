...
const AccountItem: React.FC<AccountItemType> = ({item, ...props}) => {
    return (
        <Pressable bgColor="white" justifyContent="center" borderRadius={12} height="12" mb="3" shadow={1}>
            <HStack alignItems="center" justifyContent="space-between" px={4}>

                <HStack space={3} alignItems="center" justifyContent="space-around">
                    {item.startIcon}

                    <Text fontWeight="semibold" fontSize="md" color="gray.500">{item.title}</Text>
